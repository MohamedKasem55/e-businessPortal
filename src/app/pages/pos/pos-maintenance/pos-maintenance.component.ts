...
import {POS, POS_MAINTENANCE_DETAILS} from 'app/@core/constants/pages-urls-constants';
...
@Component({
  ...
  templateUrl: './pos-maintenance.component.html',
  styleUrls: [],
})
export class PosMaintenanceComponent implements OnInit {
  ...
  title: TitleModel = {
    ...
    title: 'pos.maintenance.maint-point-of-sale',
  ...
  onSelected(terminal: string) {
    ...
    this.router.navigate([`pos/${POS_MAINTENANCE_DETAILS}`], {state: {selectedTerminal: terminal}})
  }
